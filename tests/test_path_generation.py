...
class TestGenerateOutputPathFromFlow:
    ...
    def test_single_mask_processor(self):
        ...
        flow = "mask('number')"
        path = generate_output_path_from_flow("data/AIME2025__R10/gpt-oss/p1/results.json", flow)
        expected_hash = compute_flow_hash(flow)

        assert path == f"experiments/exp/{expected_hash}/results.json"
    ...
    def test_empty_flow(self):
        ...
        path = generate_output_path_from_flow("data/AIME2025__R10/gpt-oss/p1/results.json", "")
