...
from the experiments/exp/ directory (generated by run_experiment.py).
...
Examples:
    ...
    python view_experiment.py --exp-dir experiments/exp/
"""
...
def scan_experiments(exp_dir: Path) -> List[Dict[str, Any]]:
    """
    Scan experiments/exp/ directory for all experiment results
            ...
            try {
                ...
                if (experiments.length === 0) {
                    document.getElementById('loading').innerHTML =
                        '<div class="no-results">No experiments found in experiments/exp/ directory</div>';
                    return;
                }
