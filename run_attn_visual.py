...
Output:
    ...
    - attn_data.js: Separated JavaScript data file
    - attention_instances.jsonl: Intermediate instance data (JSONL format)
    All files are saved in the same directory as the results.json file
"""
...
class HTMLGenerator:
    ...
    def generate_html(
        ...
        """
        Generate complete HTML file and separate data JS file
        ...
        Args:
            ...
            data_js_path: Path to save data JS file
        """
        # Generate data JS file
        self._generate_data_js(instances, data_js_path)
    ...
    def _generate_data_js(self, instances: List[Dict], output_path: str) -> None:
        """
...
<body>
    ...
    <script src="attn_data.js"></script>
    <script>
    ...
    def _get_javascript(self) -> str:
        ...
        function updateVisualization() {{
            ...
            const tokensHtml = tokens.map((token, i) => {{
                ...
                const border = weight > 0 ? 'border: 1px solid red;' : '';
...
def main():
    ...
    generator.generate_html(instances, str(output_html), str(data_js))
